    ...
    <head>
        ...
        <style>
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .notification-dropdown-title { font-weight: 700; font-size: 14px; color: #e2e8f0; }
            ...
            .notification-dropdown-item:hover { background: rgba(27,58,107,0.3); }
            .notification-dropdown-item:last-child { border-bottom: none; }
            .notification-dot { width: 8px; height: 8px; border-radius: 50%; margin-top: 5px; flex-shrink: 0; }
            .notification-dot-low { background: #f59e0b; }
            .notification-dot-out { background: #ef4444; }
            .notification-dropdown-item-title { font-size: 12px; font-weight: 600; color: #e2e8f0; margin: 0; }
            .notification-dropdown-item-desc { font-size: 11px; color: #94a3b8; margin: 3px 0 0; }
            .notification-dropdown-item-time { font-size: 10px; color: #64748b; margin: 3px 0 0; }
            ...
            .notification-dropdown-footer:hover { background: rgba(27,58,107,0.3); color: #7fb8f0; }
        </style>
        @stack('styles')
    </head>
    <body>
