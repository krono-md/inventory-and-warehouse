    ...
    <style>
        * {
        ...
        .page {
            ...
            /* This forces the image to stretch to the exact width and height of the container */
            background-size: 100% 100% !important; 
            
            /* Keeps it pinned dead center */
...
<body>
    ...
    <div id="splash">
        ...
        <div class="brand">
            <img src="images/Nexora_Logo_Transparent.png" class="logo" alt="Logo">
        ...
        <main class="page">
            <div class="form-col">
                <div class="login-card">
                    ...
                    <div class="links">
                        <p>Forgot Password? <a href="{{ route('signin') }}">Reset</a></p>
