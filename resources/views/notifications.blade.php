    ...
    <div style="background:#ffffff;border-radius:20px;overflow:hidden;min-width:0;">
        ...
        <form method="GET" action="{{ route('notifications') }}" style="padding:16px 20px;display:flex;align-items:center;gap:12px;flex-wrap:nowrap;min-width:0;">
            ...
            <div style="display:flex;align-items:center;background:#E2E8F0;border-radius:8px;padding:8px 14px;gap:8px;flex:1;min-width:150px;">
                ...
                <input type="text" name="search" value="{{ $filters['search'] ?? '' }}" placeholder="Search by Item Name, SKU..." style="border:none;outline:none;background:transparent;font-size:12px;font-family:'Inter',sans-serif;color:#333;width:100%;">
            </div>
            <!-- Filter: Type -->
                ...
                <tbody>
                    @forelse ($notifications as $notification)
                        <tr style="border-bottom:1px solid #e2e8f0;">
                            ...
                            <td style="text-align:center;padding:12px 8px;font-size:13px;color:#132B52;font-family:'Courier New',monospace;">{{ $notification->item->sku }}</td>
